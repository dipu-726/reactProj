        ...
        return(
           <div>
                <div className = "u-result-card u-text-center u-cushion--more-top u-cushion--more-bottom">
                     ...
                     <p className="u-message u-spacer--more-bottom">{this.props.message}</p>   
                     <p className="u-suggestion">{this.props.suggestion}</p>   
                </div>
                <div>

                        <div className="u-flex u-flex--center">
                            <p className="u-marketing-text u-spacer--x-large-top">Ask Doctors Online.</p>
